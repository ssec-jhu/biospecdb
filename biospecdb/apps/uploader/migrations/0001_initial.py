    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_observed', models.IntegerField(blank=True, default=None, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Days of symptoms onset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_class', models.CharField(choices=[('BOOL', 'Bool'), ('STR', 'Str'), ('INT', 'Int'), ('FLOAT', 'Float')], default='BOOL', max_length=128)),
                ('hipaa_compliant', models.BooleanField(blank=True, help_text='Whether observable is HIPAA (USA) compliant', null=True)),
                ('gdpr_compliant', models.BooleanField(blank=True, help_text='Whether observable is GDPR (EU) compliant', null=True)),
