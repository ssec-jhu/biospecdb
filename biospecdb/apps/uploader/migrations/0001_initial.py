    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('src_file', models.ForeignKey(blank=True, default=None, help_text='Visit created from this bulk data file', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='visits', to='uploader.uploadedfile', verbose_name='Source bulk data file')),
            ],
            options={
                'get_latest_by': 'updated_at',
            },
