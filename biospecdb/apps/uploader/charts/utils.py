# Copied from https://github.com/groveco/django-sql-explorer/blob/master/explorer/views/utils.py


from django.db import DatabaseError

from explorer import app_settings
from uploader.charts.charts import get_line_chart, get_pie_chart  # <---------- MODIFIED LINE
...
def query_viewmodel(request, query, title=None, form=None, message=None,
    ...
    ret = {
        ...
        'pie_chart_svg': get_pie_chart(res, rows) if app_settings.EXPLORER_CHARTS_ENABLED and has_valid_results else None,  # <---------- MODIFIED LINE TO INC ROWS # noqa:E501
        'line_chart_svg': get_line_chart(res, rows) if app_settings.EXPLORER_CHARTS_ENABLED and has_valid_results else None,  # <---------- MODIFIED LINE TO INC ROWS # noqa:E501
